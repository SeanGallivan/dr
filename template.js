...
const TEMPLATES = {
    practice: (data) => `
        ...
        <div class="daily-grid">
            ...
            <div class="daily-stat ${parseInt(data.labs) > 0 ? 'alert' : ''}"><span class="stat-label">Critical Labs</span><span class="stat-value">${data.labs}</span><span class="stat-sub">Review Pending</span></div>
        ...
        <div class="table-container">
            ...
            <table class="table-custom">
                ...
                <tbody>
                    <tr><td>A/R Aging (>90)</td><td>${data.ar}</td><td style="color:${parseFloat(data.ar.replace(/[^0-9.-]+/g,"")) > 10000 ? 'red' : 'green'}; font-weight:700;">${parseFloat(data.ar.replace(/[^0-9.-]+/g,"")) > 10000 ? 'Critical' : 'Healthy'}</td></tr>
