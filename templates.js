...
const TEMPLATES = {
    practice: (data) => `
        ...
        <div class="daily-grid">
            ...
            <div class="daily-stat ${parseInt(data.charts) > 10 ? 'alert' : ''}"><span class="stat-label">Unsigned Charts</span><span class="stat-value">${data.charts}</span><span class="stat-sub">Required</span></div>
            <div class="daily-stat ${parseInt(data.labs) > 0 ? 'alert' : ''}"><span class="stat-label">Critical Labs</span><span class="stat-value">${data.labs}</span><span class="stat-sub">Pending</span></div>
    ...
    patient: (p) => `
        ...
        <div class="weekly-grid">
            ...
            <div class="weekly-stat"><span class="stat-label">Pain Score</span><span class="stat-value">${p.pain}</span></div>
        </div>`
};
